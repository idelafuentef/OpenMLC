...
%% Type mlc=MLC2('toy2_cfg') to create corresponding MLC object
parameters.size=100;           
...
parameters.probrep=0.1;                             %probability of replication
parameters.probmut=0.4;                             %probability of mutation
parameters.probcro=0.5;                             %probability of crossover
