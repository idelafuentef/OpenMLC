...
%%  Type mlc=MLC2('MLC_LQR_script') to create corresponding MLC object
...
parameters.size = 100;
parameters.sensors=2;                       %number of sensors
parameters.sensor_spec=0;
parameters.controls=1;                      %number of actuation commands(Nb)=number of polynomials
...
parameters.tournamentsize=15;           %number of individuals selected for the tournament
...
parameters.evaluation_function='MLC_LQR';
